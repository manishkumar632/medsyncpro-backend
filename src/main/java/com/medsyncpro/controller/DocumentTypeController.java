...
//         /**
//          * PATCH /api/admin/document-types/mapping/{id}/rename
//          * Rename a document type. Body: { "name": "New Name" }
//          */
//         // @PatchMapping("/mapping/{id}/rename")
//         // public ResponseEntity<ApiResponse<DocumentTypeConfigResponse>> renameDocumentType(
//         //                 @PathVariable Long id,
//         //                 @RequestBody Map<String, String> body) {

//         //         String newName = body.get("name");
//         //         DocumentTypeConfigResponse config = documentTypeService.renameDocumentType(id, newName);

//         //         return ResponseEntity.ok(
//         //                         ApiResponse.success(config, "Document type renamed successfully"));
//         // }
